# Generated by Django 5.1.3 on 2024-12-17 17:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("conductivity", models.FloatField(default=1.0)),
                ("emissivity", models.FloatField(default=0.9)),
                ("source", models.CharField(blank=True, max_length=255, null=True)),
                ("comments", models.TextField(blank=True, max_length=255, null=True)),
                (
                    "color_argb",
                    models.CharField(default="255,255,255,255", max_length=16),
                ),
                (
                    "user",
                    models.ForeignKey(
